...
#DYLAN_image = face_recognition.load_image_file("C:/Users/tzhang/Desktop/personal/fianl_proj_face_recog_secure_system/family_face/DYLAN.jpg")  #for some reason the file path has to be absolute path
